                            ...
                            <div className="col-7">
                                <div className="row">
                                    <div className="mb-3 col">
                                        ...
                                        <input value={name} onChange={(e) => setName(e.target.value)} style={{ fontFamily: "Poppins", fontSize: "18px" }} type="text" name="" className="form-control form-control-lg shadow-sm" />
                                    </div>
                                    <div className="mb-3 col">
                                        <label htmlFor="">
                                            <span className="lead">Contact</span>
                                        </label>
                                        <input value={contact} onChange={(e) => setContact(e.target.value)} style={{ fontFamily: "Poppins", fontSize: "18px" }} type="contact" name="" className="form-control form-control-lg shadow-sm" />
                                ...
                                <div className="mb-3">
                                    ...
                                    <p className="text-sm text-secondary" style={{ fontFamily: "Poppins", fontSize: "12px" }}>Email address should be unique.</p>
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="">
                                ...
                                <div className="mb-3">
                                    ...
                                    <input value={confirmpassword} onChange={(e) => setConfirmPassword(e.target.value)} style={{ fontFamily: "Poppins", fontSize: "18px" }} type="password" name="" className="form-control form-control-lg shadow-sm" />
                                </div>
                                <div className="mb-1">
